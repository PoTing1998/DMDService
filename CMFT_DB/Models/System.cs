...
namespace ASI.Wanda.CMFT.DB.Models.System
{
    ...
    /// <summary>
    /// 依據設備編號及該設備的狀態參考值對應出所屬的告警編號，一個設備可以有不同的狀態參考值以對應到不同的告警編號
    /// </summary>
    public class sys_equip_alarm_match
    {
        /// <summary>  
        /// 設備編號        
        /// </summary> 
        ...
        /// <summary>  
        /// 狀態類型，default表示狀態值欄位status_value只有true(正常)和false(異常)
        /// </summary> 
        [Key]
