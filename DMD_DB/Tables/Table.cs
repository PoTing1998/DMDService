...
namespace ASI.Wanda.DMD.DB.Tables
{
    abstract public class Table<T>
    {
        ...
        static protected int Update(params object[] paramObjects)
        {
            ...
            setString += string.Format(@", upd_user = '{0}'", ASI.Wanda.DMD.DB.Manager.CurrentUserID) + "\n";
            setString += string.Format(@", upd_time = {0}", ASI.Wanda.DMD.DB.Manager.CurrentSqlTime);
        ...
        static protected int Insert(params object[] paramObjects)
        {
            ...
            endString += string.Format(@", '{0}'", ASI.Wanda.DMD.DB.Manager.CurrentUserID) + "\n";
            endString += string.Format(@", {0}", ASI.Wanda.DMD.DB.Manager.CurrentSqlTime) + "\n";
            endString += string.Format(@", '{0}'", ASI.Wanda.DMD.DB.Manager.CurrentUserID) + "\n";
            endString += string.Format(@", {0}", ASI.Wanda.DMD.DB.Manager.CurrentSqlTime);
            endString = "values(" + "\n" + endString + ")";
